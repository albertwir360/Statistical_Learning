...
set.seed(42)
rf_model <- randomForest(Class ~ ., data = Credit_Data_Training, ntree = 100)
rf_model
```
...
set.seed(42)
ind_Training_full=sample(nrow(Credit_Data),round(nrow(Credit_Data)*0.80),replace = FALSE)
Credit_Data_Training_full=Credit_Data[ind_Training_full,];
Credit_Data_Test_full=Credit_Data[-ind_Training_full,];

set.seed(42)
rf_model <- randomForest(Class ~ ., data = Credit_Data_Training_full, ntree = 100)
rf_model
